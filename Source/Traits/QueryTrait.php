...
trait QueryTrait
{
    ...
    {
        return $this->query->escape($value);
    }
    ...
    {
        return $this->query->escapeName($name);
    }
    ...
    /**
     * Used for select, insert, and update to specify column name, alias (optional, select only)
     *
    ...
    {
        return $this->query->setInsertInto($table_name);
    }
