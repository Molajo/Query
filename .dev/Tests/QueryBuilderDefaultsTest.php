...
class QueryBuilderDefaultsTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testCatalogModelRegistry()
    {
        ...
        $this->assertEquals('extension_instance_id', $model_registry['joins']['1']['jointo']);
        $this->assertEquals('extension_instance_id', $model_registry['joins']['1']['joinwith']);
        ...
        $this->assertEquals('extension_instance_id', $model_registry['joins']['2']['jointo']);
        $this->assertEquals('extension_instance_id', $model_registry['joins']['2']['joinwith']);
