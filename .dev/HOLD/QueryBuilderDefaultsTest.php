 ...
 * @since      1.0.0
 */
class QueryBuilderDefaultsTest extends PHPUnit_Framework_TestCase
{
    /**
     ...
     * @since   1.0.0
     */
    public function testSetQueryBuilderDefaults()
    {
        /** Fieldhandler */
        ...
        $model_registry = $query_builder->getModelRegistry();
    ...
    public function testCatalogModelRegistry()
    {
        ...
        $this->assertEquals('extension_instance_id', $model_registry['joins']['1']['join_to']);
        $this->assertEquals('extension_instance_id', $model_registry['joins']['1']['join_with']);
        ...
        $this->assertEquals('extension_instance_id', $model_registry['joins']['2']['join_to']);
        $this->assertEquals('extension_instance_id', $model_registry['joins']['2']['join_with']);
